...
/**
 * Cette classe représente une personne quelconque caractérisée par son nom, son prenom, sa langue
 * d'expression(par défaut le Francais) et  sa ville d'étude.
 * @author Harold
 *
 */
public class Personne {
	...
	public String toString() {
		return  " Nom : " + getNom() + " Langue : " + getLangue();
	}
}
